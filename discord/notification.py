...
embed = DiscordEmbed(title=' <:ether:855358106342129664> Gravity Ethereum Node ', description=f'Successfully build commit {NAME}  , sha : {COMMIT} on {OS} and pushed to Docker Hub at time {str(datetime.now())}', color='03b2f8')
